const translations = {
  en: {
    ...
    heroTitle: "Find local service providers for your business.",
    heroText:
      "Tell us what service you need, where your business is located, and how providers can contact you. SMEs.MY helps Malaysian SMEs find accounting, company secretary, payroll, website, marketing, IT, legal, financing, and operations support.",
    ...
    statCategories: "Business service types",
    ...
    detailsPlaceholder:
      "What problem are you trying to solve? Any deadline, software, document volume, or language preference?",
    ...
    popularTitle: "Find providers for the work SMEs buy often.",
    popularText: "Choose a service below to understand what to compare and send a quote request.",
    ...
    journeyOneTitle: "Choose a service",
    journeyOneText:
      "Select accounting, company secretary, payroll, website design, digital marketing, IT, legal, financing, or another business service.",
    ...
    findTitle: "Business services commonly used by Malaysian SMEs.",
    findText: "Use SMEs.MY when you need professional help to run, comply, digitise, hire, market, or finance your business.",
    ...
    findThreeTitle: "Money and operations",
    findThreeText: "Financing, recruitment, logistics, admin support, and other SME operating services.",
    ...
    guidesPopular: "Popular services",
    ...
    planBasicText: "Add your company name, main service, location, and contact details.",
    ...
    listTitle: "List your SME service business.",
    listText: "If you provide business services in Malaysia, submit enough details for review and lead matching.",
    providerBenefitOne: "Be discoverable by SMEs searching for your service category.",
    providerBenefitTwo: "Receive relevant enquiry opportunities when there is a fit.",
    providerBenefitThree: "Build a clearer profile with service scope, locations, and languages.",
  ...
  zh: {
    ...
    requestQuotes: "免费询价",
    listBusiness: "提交商家资料",
    heroEyebrow: "马来西亚中小企业服务",
    heroTitle: "帮你的生意找到本地服务商。",
    heroText:
      "告诉我们你需要什么服务、公司在哪里、服务商怎样联系你。SMEs.MY 帮马来西亚 SME 寻找会计、公司秘书、Payroll、网站、Marketing、IT、法律、融资和营运支援。",
    ...
    serviceMarketingShort: "Digital Marketing",
    statCategories: "常用商业服务",
    statLocal: "本地服务商搜索",
    statFree: "免费提交询价",
    freeRequest: "免费询价",
    forMalaysiaSmes: "给马来西亚 SME",
    quoteTitle: "告诉我们你需要什么。",
    quoteText: "填写服务类型、地点和联系方式。SMEs.MY 会先查看需求，适合时再转给相关服务商回复。",
    formService: "需要的服务",
    chooseService: "选择服务",
    ...
    formDetails: "补充资料",
    detailsPlaceholder: "你想解决什么问题？有没有 deadline、软件、文件数量或语言偏好？",
    sendRequest: "提交询价",
    quoteConsent: "提交后，你同意 SMEs.MY 查看你的需求，并在适合时把相关资料分享给合适服务商方便回复。",
    afterSubmitOne: "我们会查看服务类型、地点、联系方式和紧急程度。",
    afterSubmitTwo: "适合的服务商可能会收到需求资料，并直接联系你。",
    afterSubmitThree: "你可以比较回复、继续提问，再选择服务商。",
    trustOneTitle: "只做商业服务",
    trustOneText: "会计、合规、Payroll、网站、Marketing、IT、法律、融资和营运支援。",
    trustTwoTitle: "专注马来西亚",
    trustTwoText: "按服务类型、城市、语言和公司需求寻找服务商。",
    trustThreeTitle: "简单提交需求",
    trustThreeText: "不用一家一家问，先提交一次清楚的需求。",
    loopEyebrow: "平台闭环",
    loopTitle: "让 SME 和服务商可以实际对接的流程。",
    loopText: "SMEs.MY 先从清楚的需求、服务商资料和人工审核开始，用真实市场资料慢慢完善 directory。",
    loopUserTitle: "SME 提交需求",
    loopUserText: "买家填写服务类型、地点、联系方式、生意背景、紧急程度和特别要求。",
    loopAdminTitle: "SMEs.MY 查看和配对",
    loopAdminText: "需求会按分类、城市、语言和适合度检查，适合时再转给相关服务商。",
    loopProviderTitle: "服务商回复",
    loopProviderText: "服务商联系 SME、确认范围、直接报价，并通过有用的跟进建立信任。",
    opsOneTitle: "服务商审核",
    opsOneText: "Listing 应包括公司名、服务范围、地点、联系方式、网站资料和语言支持。",
    opsTwoTitle: "Lead 跟进",
    ...
    howBrowseTitle: "浏览",
    howBrowseText: "从会计、Payroll、网站设计或 Marketing 等服务分类开始。",
    howCompareTitle: "比较",
    howCompareText: "查看地点、语言、服务范围、回复速度和是否适合你的公司。",
    howRequestTitle: "询价",
    howRequestText: "一次提交资料，等待适合的服务商回复。",
    popularEyebrow: "热门服务",
    popularTitle: "找到 SME 常会购买的服务。",
    popularText: "选择一个服务，了解要比较什么，也可以直接提交询价。",
    journeyEyebrow: "使用流程",
    journeyTitle: "怎样使用 SMEs.MY。",
    journeyText: "如果你不确定该找谁，先从服务需求开始。表格会帮你把需求讲清楚，让服务商更容易回复有用的答案。",
    journeyOneTitle: "选择服务",
    journeyOneText: "选择会计、公司秘书、Payroll、网站设计、Digital Marketing、IT、法律、融资或其他商业服务。",
    journeyTwoTitle: "填写资料",
    journeyTwoText: "告诉服务商你的地点、时间、预算范围和联系方式。",
    journeyThreeTitle: "比较回复",
    journeyThreeText: "查看服务商回复，继续提问，再选择适合你公司的服务商。",
    findEyebrow: "你可以找什么",
    findTitle: "马来西亚 SME 常用的商业服务。",
    findText: "当你需要合规、数码化、招聘、市场推广、融资或营运支援时，可以从 SMEs.MY 开始。",
    findOneTitle: "会计和合规",
    findOneText: "Bookkeeping、税务、公司秘书、Payroll、HR 和法律支援。",
    findTwoTitle: "数码和增长",
    findTwoText: "网站设计、Digital Marketing、IT 系统、POS、CRM 和自动化。",
    findThreeTitle: "融资和营运",
    findThreeText: "融资、招聘、物流、行政支援和其他 SME 营运服务。",
    compareEyebrow: "怎样比较",
    ...
    providersEyebrow: "推荐服务商",
    providersTitle: "联系前先比较服务商资料。",
    providersText: "用搜索和分类筛选服务类型、地点、语言和回复速度。",
    providerSearchPlaceholder: "搜索服务商、分类或地点",
    allCategories: "全部分类",
    ...
    planBasicText: "提交公司名称、主要服务、地点和联系方式。",
    ...
    listEyebrow: "给服务商",
    listTitle: "提交你的 SME 服务公司。",
    listText: "如果你在马来西亚提供商业服务，请提交足够资料，方便审核和配对询价。",
    providerBenefitOne: "让正在搜索相关服务的 SME 更容易发现你。",
    providerBenefitTwo: "当需求适合时，获得相关询价机会。",
    providerBenefitThree: "用服务范围、地区和语言支持建立更清楚的 profile。",
    companyName: "公司名称",
    mainService: "主要服务",
