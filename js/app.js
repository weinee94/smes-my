const translations = {
  en: {
    ...
    heroText:
      "Tell us what your business needs, where you are located, and which details matter. SMEs.MY helps Malaysian SMEs compare suppliers and providers by scope, location, language, and relevant registration or licence signals.",
    ...
    listText:
      "If your company serves Malaysian SMEs, submit enough details for a useful profile. SMEs.MY is for proper providers, not anonymous or unclear listings.",
    ...
    footerOne: "helps Malaysian SMEs find and compare proper suppliers, contractors, and service providers.",
  ...
  zh: {
    ...
    heroText:
      "告诉我们你的公司需要什么、在哪里、哪些细节重要。SMEs.MY 帮马来西亚 SME 按服务范围、地点、语言，以及相关注册或执照信号来比较供应商和服务商。",
    ...
    listText: "如果你的公司服务 Malaysian SMEs，请提交足够资料做成有用 profile。SMEs.MY 鼓励正规企业，不收匿名或资料不清楚的 listing。",
    ...
    applyListing: "申请加入",
    footerOne: "帮助马来西亚 SME 寻找和比较正规供应商、承包商和服务商。",
