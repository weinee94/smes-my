const translations = {
  en: {
    ...
    heroEyebrow: "Find business services in Malaysia",
    heroTitle: "Find local suppliers and service providers for your business.",
    heroText:
      "Tell us what you need, where your business is located, and how providers can contact you. SMEs.MY helps Malaysian SMEs find packaging suppliers, accounting, company secretary, payroll, website, marketing, IT, financing, and operations support.",
    heroPillOne: "For Malaysian SME owners",
    heroPillTwo: "English, BM, and Chinese-friendly support",
    searchPlaceholder: "Search packaging, accounting, website design...",
    ...
    forMalaysiaSmes: "For Malaysia SMEs",
    ...
    previewTitle: "A cleaner way to compare SME suppliers before you contact them.",
    previewText:
      "SMEs.MY is being built around structured profiles: what the company does, where it serves, which languages it supports, and what kind of enquiries are suitable.",
    sampleDirectory: "Sample directory view",
    sampleAccountingTitle: "Accounting & tax support",
    sampleAccountingText: "Kuala Lumpur · English / BM / 中文 · Monthly accounts, tax filing, SST",
    samplePackagingTitle: "Packaging supplier",
    samplePackagingText: "Selangor · Custom boxes, labels, food packaging, low MOQ enquiries",
    previewSignalTitle: "What makes a listing useful",
    previewSignalText: "Scope, location, languages, response channel, and proof that the company is still active.",
    ...
    popularTitle: "Find providers and suppliers for what SMEs buy often.",
    ...
    findTitle: "Suppliers and services commonly used by Malaysian SMEs.",
    ...
    compareText:
      "Use these checks when you compare accounting firms, company secretaries, payroll teams, web designers, marketers, IT vendors, and other business service providers.",
    tableCheck: "Check",
    ...
    planVerifiedTitle: "Verified profile",
    comingSoon: "Coming soon",
    planVerifiedText: "Show more details such as service scope, languages, locations, and business fit.",
    planEnquiryTitle: "Customer enquiries",
    relevantRequests: "Relevant requests",
    planEnquiryText: "Receive requests from SME owners looking for your type of service.",
    listEyebrow: "For service providers",
    listTitle: "Apply for an early SMEs.MY listing.",
    listText: "If your business serves Malaysian SMEs, submit enough detail for a useful profile. Thin listings may not be published.",
    ...
    footerOne: "helps Malaysian SMEs find and compare business service providers.",
  ...
  zh: {
    ...
    listBusiness: "提交商家资料",
    whyList: "为什么加入？",
    heroEyebrow: "马来西亚中小企业供应商和服务",
    heroTitle: "帮你的生意找到本地供应商和服务商。",
    heroText:
      "告诉我们你需要什么、公司在哪里、供应商怎样联系你。SMEs.MY 帮马来西亚 SME 寻找包装供应商、会计、公司秘书、Payroll、网站、Marketing、IT、融资和营运支援。",
    heroPillOne: "给马来西亚中小企业老板",
    heroPillTwo: "支持 English、BM 和中文沟通",
    searchPlaceholder: "搜索包装、会计、网站设计...",
    browseServices: "浏览服务",
    searchServices: "搜索分类",
    ...
    previewTitle: "在联系供应商前，先用更清楚的资料做比较。",
    previewText: "SMEs.MY 会围绕结构化资料建设：公司做什么、服务哪里、支持什么语言、适合接什么询价。",
    sampleDirectory: "目录样式预览",
    sampleAccountingTitle: "会计与税务支持",
    sampleAccountingText: "Kuala Lumpur · English / BM / 中文 · 月账、报税、SST",
    samplePackagingTitle: "包装供应商",
    samplePackagingText: "Selangor · 定制纸盒、标签、食品包装、小 MOQ 询价",
    previewSignalTitle: "什么 listing 才有用",
    previewSignalText: "服务范围、地点、语言、回复渠道，以及公司仍在营业的信号。",
    loopEyebrow: "平台闭环",
    ...
    popularEyebrow: "热门分类",
    popularTitle: "找到 SME 常会购买的供应和服务。",
    ...
    compareText: "比较会计公司、公司秘书、Payroll 团队、网站设计、Marketing、IT 和其他商业服务商时，可以用这些检查点。",
    tableCheck: "检查点",
    tableWhy: "为什么重要",
    tableAsk: "可以问什么",
    tableCompany: "公司资料",
    ...
    planVerifiedTitle: "认证资料页",
    comingSoon: "即将推出",
    planVerifiedText: "展示服务范围、语言、服务地区和适合的客户类型。",
    planEnquiryTitle: "客户询价",
    relevantRequests: "相关需求",
    planEnquiryText: "接收正在寻找你这类服务的 SME 需求。",
    listEyebrow: "给服务商",
    listTitle: "申请早期 SMEs.MY listing。",
    listText: "如果你的业务服务 Malaysian SMEs，请提交足够资料做成有用 profile。资料太薄的 listing 不一定发布。",
    ...
    applyListing: "申请加入",
    footerOne: "帮助马来西亚 SME 寻找和比较商业服务商。",
    footerTwo: "需要帮忙选择服务商？先从服务分类开始，或提交询价。",
    profileChecked: "资料已检查",
...
let currentLang = localStorage.getItem("smesLang") || "en";
